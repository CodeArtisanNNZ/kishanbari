...
const steps = [
  ...
  () => `
    ...
    <p>
      হাতে পরীক্ষা করে সবচেয়ে কাছের ধরনটি বেছে নিন।
    </p>
...
async function submitSoilTest() {
  ...
  try {
    ...
    soilForm.classList.remove("loading");
